...
export class Migration1724885293170 implements MigrationInterface {
    name = 'Migration1724885293170'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "usuario" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nome" character varying(100) NOT NULL, "email" character varying(100) NOT NULL, "data_nascimento" TIMESTAMP NOT NULL, "senha" character varying(255) NOT NULL, "imagem" text, "refreshToken" text, "cidadeId" uuid, CONSTRAINT "PK_a56c58e5cabaa04fb2c98d2d7e2" PRIMARY KEY ("id"))`);
