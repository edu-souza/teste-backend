...
export class GeraTabelasAtu1719182294881 implements MigrationInterface {
    name = 'GeraTabelasAtu1719182294881'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "evento" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "titulo" character varying(100) NOT NULL, "descricao" text NOT NULL, "tipo" character varying(100) NOT NULL, "data" TIMESTAMP NOT NULL, "hora" TIME, "diaSemana" character varying, "quantidadeParticipantes" integer NOT NULL, "bairro" character varying NOT NULL, "rua" character varying NOT NULL, "numero" character varying NOT NULL, "complemento" character varying, "status" character varying NOT NULL, "cidadeId" uuid, "modalidadeId" uuid, CONSTRAINT "PK_ceb2e9607555230aee6aff546b0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "usuario" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nome" character varying(100) NOT NULL, "email" character varying(100) NOT NULL, "data_nascimento" TIMESTAMP NOT NULL, "senha" character varying(255) NOT NULL, "cidadeId" uuid, CONSTRAINT "PK_a56c58e5cabaa04fb2c98d2d7e2" PRIMARY KEY ("id"))`);
