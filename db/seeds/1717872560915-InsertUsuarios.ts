...
export class InsertUsuarios1717872560915 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            "INSERT INTO usuario (id, nome, email, data_nascimento, senha) VALUES ('123e4567-e89b-12d3-a456-426614174000', 'João Silva', 'joao.silva@gmail.com', '1990-01-15 00:00:00', '$2a$10$A5c8F2mL5E7oG9H0fZjNU.4Iwm9Z8sUwLAA07Tdr0LtM8i7M7W8Ue'); " +
